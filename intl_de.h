...
const char INTL_GPS[] PROGMEM = "Position";
const char INTL_NEO6M[] PROGMEM = "Hardware (NEO 6M)";
const char INTL_GPS_FAKE[] PROGMEM = "Manuell";
...
const char INTL_OLED_DISPLAY[] PROGMEM = "OLED Display";
...
const char INTL_GERAT_NEU_STARTEN[] PROGMEM = "Sensor neu starten";
...
#if defined(LORA)
const char INTL_LORA_NWSKEY[] PROGMEM = "network session key (NwkSKey)";
const char INTL_LORA_APPSKEY[] PROGMEM = "Application Session key (AppSKey)";
const char INTL_LORA_DEVADDR[] PROGMEM = "end-device address (DevAddr)";
#endif
