...
/************************************************************************/
// increment on change
#define SOFTWARE_VERSION "NRZ-2018-xxx_ESP32" // based on airrohr #103 
...
static uint8_t lora_data[] = "test1234";
...
void onEvent (ev_t ev) {
    ...
    switch(ev) {
        ...
        case EV_TXCOMPLETE:
            ...
            os_setTimedCallback(&sendjob, os_getTime()+sec2osticks(TX_INTERVAL), lora_do_send);
            break;
        case EV_LOST_TSYNC:
...
#if defined(OLED_DISPLAY) // workaround u2g8 font
			if (t_sensor != "") { display_lines[line_count++] = "Temp.: " + check_display_value(t_value, -128, 1, 6) + TEMP_LABEL; }
#else
